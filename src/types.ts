...
export interface ExerciseLog {exerciseId:string;sets:TrainingSet[];notes:string;skipped?:boolean;originalExerciseId?:string;repRange?:{min:number;max:number};targetRir?:string;restSeconds?:number;tempo?:string}
